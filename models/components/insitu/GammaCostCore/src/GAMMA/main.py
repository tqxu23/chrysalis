...
if __name__ == "__main__":
    ...
    parser.add_argument('--inter', default=False, action='intermittent', help='Intermittent Computing Approvement.')
    ...
    try:
        train_model(model_defs, input_arg=opt, map_cstr=map_cstr, chkpt_file=chkpt_file,inter=opt.inter)
