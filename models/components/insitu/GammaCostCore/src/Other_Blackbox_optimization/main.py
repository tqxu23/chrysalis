...
def eval_function_2_level(env, indv0, indv1, indv2, indv3, indv4, indv5, indv6, indv7, indv8, indv9, indv10, indv11, indv12, indv13, indv14, indv15, indv16):
    indv = [indv0, indv1, indv2, indv3, indv4, indv5, indv6, indv7, indv8, indv9, indv10, indv11, indv12, indv13, indv14, indv15, indv16]
    return get_reward(env, indv)
...
def ng_search_2_level(env,num_generations=100,num_population=100,dimension=None,choose_optimizer=None):
    ...
    indv16=ng.p.Scalar(lower=0, upper=6).set_integer_casting())
